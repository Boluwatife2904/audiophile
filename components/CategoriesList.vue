...
<template>
	<div class="categories-list">
		<div class="categories-list__container container grid">
			<div v-for="category in categories" :key="category" class="category-item text-center position-relative flex flex-column">
				<div class="category-item__image position-relative flex items-center content-center mx-auto">
					<img :src="`/images/categories/${category}.png`" :alt="`${category} image`" class="img-fluid" />
