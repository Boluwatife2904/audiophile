...
<template>
	<div class="home-yx1 grid">
		<div class="home-yx1--left br-8">
			<img src="/images/yx1-mobile.png" alt="YX1 earphones" class="img-fluid br-8 mobile" />
			<img src="/images/yx1-tablet.png" alt="YX1 earphones" class="img-fluid br-8 tablet" />
			<img src="/images/yx1-desktop.png" alt="YX1 earphones" class="img-fluid br-8 desktop" />
		</div>
...
.home-yx1 {
	...
	&--right {
		@include padding(0 2.4rem, 0 4.1rem, 0 9.5rem);
		@include gap(3.2rem);
	}
}
</style>
